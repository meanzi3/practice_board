...
public class PostsApiControllerTest {
  ...
  @Test
  @WithMockUser(roles="USER") // 인증된 모의(가짜) 사용자를 만들어서 사용한다. => ROLE_USER 권한을 가진 사용자가 API를 요청하는 것
  public void Posts_등록() throws Exception{
    ...
    // 생성된 MockMvc를 통해 API를 테스트한다. 본문 영역은 문자열로 표현하기 위하여 ObjectMapper를 이용해 문자열 JSON으로 변환한다.
